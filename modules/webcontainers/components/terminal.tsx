...
TerminalComponent = forwardRef<TerminalRef, TerminalProps>(({ 
 ...
 const initializeTerminal = useCallback(async () => {
  ...
  try {
    ...
    const webLinksAddonModule = await import(
      "xterm-addon-web-links"
    );
    const searchAddonModule = await import(
      "xterm-addon-search"
    );
    ...
    const SearchAddonConstructor =
      searchAddonModule.SearchAddon;
    ...
    const fitAddonInstance = new FitAddonConstructor();
    const webLinksAddon = new WebLinksAddonConstructor();
    const searchAddonInstance = new SearchAddonConstructor();
